...
const GuessItemName: FC<itemString> = ({ items, itemsId }) => {
    const { changeGameMode, correctItem, defaultPlay, gameMode, handleAnswerClicked, playEayMode, repeat, score, correctItemId, suggestions, handleClickButton, inputRef } = useGuessItemName(items, itemsId);
